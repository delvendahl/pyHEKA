...
class BundleItem(Struct):
    Start: int = struct_field("i")
    Length: int = struct_field("i")
...
class BundleHeader(Struct):
    ...
    Reserved: str = struct_field("11s", None)
...
class SweepRecord(TreeNode):
    ...
    SwUserParams: float = struct_field("2d")
    PipPressure: float = struct_field("d")
    RMSNoise: float = struct_field("d")
    ...
    DigitalOut: int = struct_field("h")
    Filler1: int = struct_field("h", None)
    Markers: float = struct_field("4d")
    Filler2: int = struct_field("i", None)
    CRC: int = struct_field("I")
    SwHolding: float = struct_field("16d")
    SwUserParamEx: float = struct_field("8d")
    size_check = 352
...
class AmplifierState(Struct):
    ...
    Selector: bytes = struct_field("c", cbyte)
...
class GroupRecord(TreeNode):
    ...
    CRC: int = struct_field("I")
    MatrixWidth: float = struct_field("d")
    MatrixHeight: float = struct_field("d")
    size_check = 144
