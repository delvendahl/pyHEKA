...
class BundleItem(Struct):
    Start: int = field(metadata={"fmt": "i"})
    Length: int = field(metadata={"fmt": "i"})
...
class BundleHeader(Struct):
    ...
    Reserved: str = field(metadata={"fmt": "11s", "func": None})
...
class AmplifierState(Struct):
    ...
    SerialNumber: str = field(metadata={"fmt": "8s", "func": cstr})
    ...
    Selector: bytes = field(metadata={"fmt": "c", "func": cbyte})
